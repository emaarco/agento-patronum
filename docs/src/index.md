...
hero:
  ...
  actions:
    ...
    - theme: alt
      text: View on GitHub
      link: https://github.com/emaarco/agento-patronum

features:
  - icon: "\uD83D\uDD12"
    title: No Build, No Daemon, No Account
    details: Pure Node.js skills and shell scripts. Nothing to compile, nothing running in the background, no signup required. Two commands to install.
  - icon: "\uD83D\uDEE1\uFE0F"
...
<code class="cta-command">/plugin marketplace add emaarco/agento-patronum</code>
</div>
<div class="cta-step">
