...
```bash
claude plugin update patronum@agento-patronum
```
...
```bash
# Suspend
claude plugin disable patronum@agento-patronum

# Resume
claude plugin enable patronum@agento-patronum
```
...
claude plugin uninstall patronum@agento-patronum --scope project

# Remove from local scope only
claude plugin uninstall patronum@agento-patronum --scope local
```
...
```bash
/plugin uninstall patronum@agento-patronum
```
...
```bash
claude plugin uninstall patronum@agento-patronum
```
