...
<code class="cta-command">/plugin marketplace add agento-patronum/agento-patronum</code>
</div>
<div class="cta-step">
<span class="cta-step-label">2</span>
<code class="cta-command">/plugin install agento-patronum@agento-patronum</code>
</div>
</div>
